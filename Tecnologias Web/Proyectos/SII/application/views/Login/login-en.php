	...
	<div class="login-html">
		...
		<div class="login-form">
			<div class="sign-in-htm">
				    <?= form_open('entrar/acceso')?>
				<div class="group">
					<label for="user" class="label">Usuario</label>
					<input id="user" type="text" class="input" name="usuario">
				</div>
				<div class="group">
					<label for="pass" class="label">Contracenia</label>
					<input id="pass" type="text" class="input" name="contra" data-type="password">
				</div>
				<div class="group">
				...
				<div class="hr"></div>
				<div class="foot-lnk">
					<a href="#forgot">olvidaste tu contracenia?</a>
				</div>
				       <?= form_close()?>
			</div>
