<?php
	require_once "ClaseEntrada.php";
	$objeto=new ClaseEntrada();
	$Estudiante=$objeto->Estudiantes();
	$datos=$objeto->modulos();
error_reporting(0);
...
<body>
 <div class="container">
        ...
        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#">
            ...
            <ul class="dropdown-menu" class="nav nav-tabs">
              <li><a href="../Materias/AltaMateria.php" >Materias</a></li> 
              <li><a href="../unidades/alta.php">Unidades</a></li> 
              <li><a href="../Criterios/alta.php" >Criterios</a></li>
              <li><a href="../Alumnos/AltaAlumnos.php" >Alumnos</a></li>
  ...
  <div class="row">
    ...
    <div class="col-sm-6">
    <h2>Dia: <?php echo date('l jS \of F Y h:i:s A'); ?></h1>
       <table class="table">
       <tr>
        <th>
          Modulos
