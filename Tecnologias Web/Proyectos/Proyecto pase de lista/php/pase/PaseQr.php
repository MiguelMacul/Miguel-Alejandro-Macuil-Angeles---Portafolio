<?php
    if (isset($_POST['enviar'])){
        header("Location:Registrado.php?matricula=".$_POST['alumnos']);
    }
    ...
    <div class="col-sm-6">
      <div align="center">
        <form method="POST" class="form">
          <label>Ingresa la matricula del pase</label><br>
          <input type="" name="alumnos"><br><br>
          <button type="submit" class="btn btn-default" name="enviar" class="button">Enviar</button>
        </form>
      </div>
    </div><!--col 6-->
    <div class="col-sm-6">
